  ...
  return (
    <div className="bg-nkd-dark min-h-screen text-nkd-white overflow-hidden pb-20">
      ...
      <section className="py-16 px-8 md:px-16 lg:px-24 max-w-[1920px] bg-gray-50 rounded-[2.5rem] md:rounded-[3rem] my-10 shadow-sm border border-gray-100 mx-4 md:mx-8 lg:mx-12">
        ...
        <div ref={classesScrollRef} className="flex overflow-x-auto pb-6 gap-6 snap-x hide-scrollbar">
        ...
        <div className="flex justify-between items-center mt-6">
          ...
          <div className="flex gap-3">
            <button onClick={() => scrollCarousel(classesScrollRef, 'left')} className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-colors bg-transparent"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7"></path></svg></button>
            <button onClick={() => scrollCarousel(classesScrollRef, 'right')} className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-colors bg-transparent"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f0efef] px-6 md:px-12 lg:px-24 mx-4 md:mx-8 lg:mx-12 rounded-[2.5rem] md:rounded-[3rem] my-10 overflow-hidden">
        <div className="max-w-[1920px] mx-auto">
          ...
          <div className="flex justify-end gap-3 mt-4 pr-4">
            <button onClick={() => scrollCarousel(teamScrollRef, 'left')} className="w-12 h-12 rounded-full border-2 border-[#1e1e1e] flex items-center justify-center text-[#1e1e1e] hover:bg-[#1e1e1e] hover:text-white transition-colors bg-transparent"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7"></path></svg></button>
            <button onClick={() => scrollCarousel(teamScrollRef, 'right')} className="w-12 h-12 rounded-full border-2 border-[#1e1e1e] flex items-center justify-center text-[#1e1e1e] hover:bg-[#1e1e1e] hover:text-white transition-colors bg-transparent"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></button>
          </div>
        </div>
      </section>
